...
A single view to skim the cohort before Monday stand-up.

!!! note "How to read this page"
    - **Weekly log** links straight to each intern's Google Doc.
    - **Progress** is a rough self-rating filled in by the student each Friday.
    - **Status** updates after each Friday review.

## :material-radar: Cohort snapshot
...
| _TBD intern 5_ | — | — | — | — | :material-seed: not yet onboarded |
| _TBD intern 6_ | — | — | — | — | :material-seed: not yet onboarded |
...
## :material-comment-question: Open questions for the PI

> Edit this section after each weekly review. Keep it short — the actual
> discussion lives as comments inside each student's Google Doc.

- _(none yet — first kickoff is Jun 26)_

## :material-bookmark-multiple: Quick links

- [Schedule](schedule.md)
- [Resources](resources/index.md)
- [Weekly log template](resources/weekly-template.md)
