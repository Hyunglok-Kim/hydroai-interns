...
## :material-calendar-week: Week 1 — Kickoff (6/22 – 6/26)
...
!!! note "이 페이지는 모든 인턴이 함께 사용합니다"
    아래 학생 카드에 본인 이름이 없다면, 합류 시점에 카드와 주제가 추가됩니다.
    같은 Week 1 체크리스트가 모든 인턴에게 적용됩니다 — 합류한 첫 주에 동일한
    준비 과정을 거치게 됩니다.
...
!!! tip "Doc 만드는 법 — 연구실 Google Drive 사용"
    ...
    [:material-google-drive: **연구실 공유 폴더 열기 (권한 요청)**](https://drive.google.com/drive/folders/1UcmBGLIeBuQFV7Lwoxy0Q5b2XO74MWIe?usp=drive_link){ .md-button .md-button--primary target="_blank" }

    1. 위 버튼으로 폴더 접속 → **접근 권한 요청** (Slack으로 교수님께 알림)
